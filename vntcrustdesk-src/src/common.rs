...
pub fn get_uri_prefix() -> String {
    format!("{}://", crate::vntc::app_id())
}

#[inline]
pub fn get_service_name() -> String {
    crate::vntc::service_name().to_owned()
}

#[inline]
pub fn get_executable_basename() -> String {
    crate::vntc::executable_basename().to_owned()
}

#[inline]
pub fn get_executable_name() -> String {
    crate::vntc::executable_name().to_owned()
}

#[inline]
pub fn get_install_dir_name() -> String {
    crate::vntc::install_dir_name().to_owned()
}
...
pub fn using_public_server() -> bool {
    if crate::vntc::is_direct_only_mode() {
        return false;
    }
